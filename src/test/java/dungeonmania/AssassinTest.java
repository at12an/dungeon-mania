...
public class AssassinTest {
    ...
    public void testAssassinBribedSuccessfully() {
        ...
        DungeonResponse res = dmc.newGame("d_assassinTest_bribeSuccess", "c_assassinBribeSuccess");
    ...
    public void testAssassinBribedUnsuccessfully() {
        ...
        DungeonResponse res = dmc.newGame("d_assassinTest_bribeSuccess", "c_assassinBribeUnsuccess");
    ...
    public void testNoBribeNoMoney() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_assassinTest_NoBribe", "c_assassinBribeUnsuccess");
    ...
    public void testEnoughMoneyNotInRange() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_assassinTest_bribeSuccess", "c_assassinOutOfBribeRadius");
    ...
    public void testAssassinMovementInvisibleOutsideRecon() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_assassinTest_InvisibleMove", "c_assassinInvisibleMove");
        EntityResponse check = TestUtils.getEntities(res, "invisibility_potion").get(0);
    ...
    public void testAssassinInsideReconInvisible() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_assassinTest_InvisibleMove", "c_assassinInsideRecon");
        EntityResponse check = TestUtils.getEntities(res, "invisibility_potion").get(0);
    ...
    @Test 
    @DisplayName("Test basic battle with player and assassin") 
    public void testBasicBattleAssassin() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_assassinTest_InvisibleMove", "c_assassinInvisibleMove");
        ...
        DungeonResponse dr1 = dmc.getDungeonResponseModel();
        List<BattleResponse> battle = dr1.getBattles();
